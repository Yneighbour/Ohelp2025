...
import com.soft.ob.serviceorder.service.PingjiaService;
...
public class PingjiaServiceImpl implements PingjiaService {
    ...
    public Pingjia updatePingjia(Long id, Pingjia pingjia) {
        ...
        existingPingjia.setPingjiaUuid(pingjia.getPingjiaUuid());
        ...
        existingPingjia.setCreateTime(pingjia.getCreateTime());
        existingPingjia.setUpdateTime(pingjia.getUpdateTime());
