...
import com.soft.ob.health.service.JifenzengjiaService;
...
public class JifenzengjiaServiceImpl implements JifenzengjiaService {
    ...
    public Jifenzengjia updateJifenzengjia(Long id, Jifenzengjia jifenzengjia) {
        ...
        existingJifenzengjia.setCreateTime(jifenzengjia.getCreateTime());
        existingJifenzengjia.setUpdateTime(jifenzengjia.getUpdateTime());
